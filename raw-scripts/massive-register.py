...
ACCOUNT_MAIN_ID = "d4ea9dc6-7bdc-4b1c-a21f-54b138f1d3a5"
SITE_ID = "d0b94036-e7b8-4a0b-bb7e-d95349680b47"
...
def fetch_course_details(course_name):
    ...
    API_URL = "https://api.prod.timetoknow.com/AdminService/channels/headers/v2"
    params = {
...
def fetch_instructor_details(instructor_company_ids, course_id):
    """
    Resgata as informacoes do instrutor a partir da matricula Vivo e do curso desejado.
    
    Parametros:
        instructor_comapny_id: matricula Vivo.
    ...
    for instructor_company_id in instructor_company_ids:
        API_URL = "https://api.prod.timetoknow.com/AdminService/users"
        params = {
...
def register_course(instructor_ids, course_details_list):
    ...
    API_URL = f"https://api.prod.timetoknow.com/AdminService/v2/channels/"\
                f"save?accountId={ACCOUNT_MAIN_ID}&isRecursiveGroup=true"
    responses = []
    pause_time = 5 # Pausa entre as requisicoes das APIs
...
if __name__ == "__main__":
    ...
    course_names = ['TR Pme Convergente', 'TR Pme +', 'TR Carteira E2E']

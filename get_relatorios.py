...
COURSES_ID_API = 'https://api.prod.timetoknow.com/ReportsService/channels'
REPORTS_API = 'https://api.prod.timetoknow.com/ReportsService/report/participants/export/get'
REPORTS_NAMES = ['Consultas e Ajustes - Salesforce', 'Apresentação Área Segura']
...
def get_report_data(channel_id, csv_writer, csv_file):
    ...
    report_api = 'https://api.prod.timetoknow.com/ReportsService/report/participants/export/get'
    report_data = {
